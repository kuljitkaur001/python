...
string = string.upper() #it makes all the values entered in a string .. in lower case , then ot stores them in the same string ....., and al the functions happenns in the same string 
...
for i in range(0,n): # i start moving from 0 and go uptp n-1 index val . , n is length , that s we already reterived
    ...
    # if(string[i] == string[n-1] and string.upper()== string.lower()): #start comparing indexes, not first and last but all , here in if , what we write , exactly what we reteivie 
